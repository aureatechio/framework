...
;(function () {
  ...
  function runDashboardMain() {
    (function() {
          ...
          if (missing.length) {
            for (const chunk of chunkArray(missing, 500)) {
              ...
              (data || []).forEach((r) => {
                ...
                __etapaIndexCache.set(id, (r.index != null) ? Number(r.index) : 999);
              });
              chunk.forEach((id) => {
                if (!found.has(id)) {
      ...
      // Regra de produto: só contabilizar reuniões com score_final preenchido OU do tipo Ligação.
      ...
      async function fetchMeetingsTab() {
        ...
        const attempts = [
          'id, data, hora, statusReuniao, vendedor, leadId, score_final, score_justificativa, relatorio_ia, linkMeet, tipo_agendamento',
          'id, data, hora, statusReuniao, vendedor, leadId, score_final, score_justificativa, relatorio_ia, tipo_agendamento',
          'id, data, hora, statusReuniao, vendedor, leadId, score_final, tipo_agendamento',
      ...
      // Logos dos times (Supabase Storage)
      const TEAM_LOGOS = {
        'soberano': 'https://awqtzoefutnfmnbomujt.supabase.co/storage/v1/object/public/cdn-assets/team-logos/soberano.jpg',
        'ragnarok': 'https://awqtzoefutnfmnbomujt.supabase.co/storage/v1/object/public/cdn-assets/team-logos/ragnarok.jpg'
      };
      ...
      async function fetchTeamBattleData() {
        ...
        try {
          ...
          const metaFatPorElegivel = totalElegiveis > 0 ? TB_METAS.faturamento / totalElegiveis : 0;
...
<table>
  ...
  <tr>
    ...
    ${card('Taxa No-show', `<span style="color:${d.noShowRate > 30 ? '#ef4444' : '#0f172a'}">${d.noShowRate.toFixed(1)}%</span>`, '<span style="font-size:11px;color:#64748b;">hoje</span>')}
      ...
      // Delegação global de eventos para [data-tooltip]
      try {
      ...
      function sortStageColumns(stageNames, etapaIdsByName) {
        return stageNames
          .map(name => {
            ...
            // Buscar o menor index entre os etapaIds com este nome
